			...
			<td>
				<div id="main">
					...
					<div id="ajoutCommande">
						<div class="title" style="width: 300px;">Ajouter une ligne
							commande</div>
						<br /> <label>Commande</label> <select
							onchange="changeCommande()" id="selectCommande">
						...
						<label>Article</label> <select id="selectArticle" onchange="changeArticle()">
						...
						<br/><label>Quantit&eacute;</label><input type="text" id="quantite" value='0' />
						<br/><a id="action"
							onclick="modifLien()" href="http://"><button>Cr&eacute;er
								la ligne</button></a>
						...
						<script type="text/javascript">
							...
							function modifLien() {
								document.getElementById("action").href = "insertLig?Com="
